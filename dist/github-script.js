        ...
        return __asyncGenerator(this, arguments, function* globGenerator_1() {
          ...
          while (stack.length) {
            ...
            if (stats.isDirectory()) {
              ...
              const childItems = (yield __await(fs.promises.readdir(item.path))).map((x) => new internal_search_state_1.SearchState(path3.join(item.path, x), childLevel));
...
var require_dist_node18 = __commonJS({
  "node_modules/@octokit/plugin-retry/dist-node/index.js"(exports, module2) {
    "use strict";
    var __create2 = Object.create;
    var __defProp2 = Object.defineProperty;
    var __getOwnPropDesc2 = Object.getOwnPropertyDescriptor;
...
var require_dist_node19 = __commonJS({
  "node_modules/@octokit/plugin-paginate-graphql/dist-node/index.js"(exports, module2) {
    "use strict";
    var __defProp2 = Object.defineProperty;
    var __getOwnPropDesc2 = Object.getOwnPropertyDescriptor;
    var __getOwnPropNames2 = Object.getOwnPropertyNames;
    ...
    var dist_src_exports = {};
    __export2(dist_src_exports, {
      paginateGraphql: () => paginateGraphql2
    });
    module2.exports = __toCommonJS2(dist_src_exports);
    var import_core3 = require_dist_node16();
    ...
    var import_core4 = require_dist_node16();
    ...
    var import_core22 = require_dist_node16();
    ...
    function paginateGraphql2(octokit) {
      octokit.graphql;
      return {
...
// github-script/index.ts
var core4 = __toESM(require_core());

// src/github-script/main.ts
...
var import_core2 = __toESM(require_dist_node16());
var import_plugin_request_log = __toESM(require_dist_node17());
var import_plugin_retry = __toESM(require_dist_node18());

// src/github-script/async-function.ts
...
// src/github-script/retry-options.ts
...
function getRetryOptions(retries, exemptStatusCodes, defaultOptions) {
  ...
  core.debug(
    `GitHub client configured with: (retries: ${requestOptions.retries}, retry-exempt-status-code: ${retryOptions.doNotRetry ?? "octokit default: [400, 401, 403, 404, 422]"})`
  );
...
// src/github-script/wrap-require.ts
...
var import_core = __toESM(require_dist_node16());
var import_plugin_paginate_graphql = __toESM(require_dist_node19());
...
async function installGhCli() {
  ...
  if (!toolPath) {
    ...
    const extractedPath = await tc.extractTar(downloadPath, void 0, [
      "xz",
      "--strip",
      "1"
    ]);
  ...
  return path2.join(toolPath, "bin", "gh");
}
...
function getOctokit() {
  const token = core2.getInput("token", { required: true });
  const PaginatedOctokit = import_core.Octokit.plugin(import_plugin_paginate_graphql.paginateGraphql);
...
var SingleSelectOptionNotFoundError = class extends Error {
  constructor() {
  ...
  try {
    ...
    if (error instanceof import_graphql.GraphqlResponseError) {
      if (error.errors?.[0].type === "NOT_FOUND") {
        ...
        if (path3.length === 1) {
          throw new ProjectNotFoundError();
        } else if (path3.length === 2 && path3.at(1) === "field") {
...
async function archiveItem(owner, projectNumber, id, archived = true) {
  const args = [
    "project",
    "item-archive",
    projectNumber,
...
async function closeProject(owner, projectNumber, closed = true) {
  const args = [
    "project",
    "close",
    projectNumber,
...
async function deleteItem(owner, projectNumber, id) {
...
async function deleteProject(owner, projectNumber) {
  try {
    await execCliCommand(["project", "delete", projectNumber, "--owner", owner]);
  } catch (error) {
    handleCliError(error);
  }
}
async function editItem(projectId, id, edit) {
  ...
  if (edit.field && edit.fieldValue !== void 0) {
    const octokit = getOctokit();
    let projectV2Item;
    try {
    ...
    switch (projectV2Item.project.field.dataType) {
      ...
      case "SINGLE_SELECT":
        try {
          const { projectV2: project } = await octokit.graphql(
...
async function editProject(owner, projectNumber, edit) {
  const args = [
    "project",
    "edit",
    projectNumber,
...
function getOctokit2(token, options, ...additionalPlugins) {
  const MyOctokit = import_core2.Octokit.plugin(...additionalPlugins);
  return new MyOctokit({ ...options, auth: token });
}
async function main() {
  const token = core3.getInput("github-token", { required: true });
  const debug2 = core3.getBooleanInput("debug");
  const userAgent = core3.getInput("user-agent");
  const previews = core3.getInput("previews");
  const retries = parseInt(core3.getInput("retries"));
  const exemptStatusCodes = parseNumberArray(
    core3.getInput("retry-exempt-status-codes")
  );
  const [retryOpts, requestOpts] = getRetryOptions(
    retries,
    exemptStatusCodes,
    import_utils.defaults
  );
  const opts = {
    log: debug2 ? console : void 0,
    userAgent: userAgent || void 0,
    previews: previews ? previews.split(",") : void 0,
    retry: retryOpts,
    request: requestOpts
  };
  const github = getOctokit2(token, opts, import_plugin_retry.retry, import_plugin_request_log.requestLog);
  const script = core3.getInput("script", { required: true });
  ...
  let encoding = core3.getInput("result-encoding");
...
function handleError(err) {
  console.error(err);
  core4.setFailed(`Unhandled error: ${err}`);
}
